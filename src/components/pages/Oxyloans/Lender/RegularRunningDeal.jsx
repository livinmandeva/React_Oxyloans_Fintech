...
import { Link } from "react-router-dom";import {regular_Api} from '../../../HttpRequest/afterlogin'
    ...
    <div className="col-sm-12 col-lg-12 col-xl-12 col-12 my-lg-2">
      <div className="card invoices-grid-card w-100 h-25">
        <div className="card-header row">
          ...
          <div className="col-sm-12 col-lg-2">RoI : {data.rateOfInterest} %</div>
        ...
        <div className="card-middle row">
          <div className="col-sm-12 col-lg-6">
            <h6>Deal Opened Time : {data.fundsAcceptanceStartDate}</h6>
            <h6>Deal Closing Time : {data.fundsAcceptanceEndDate}</h6>
            <h6>First Participation : {data.firstParticipationDate}</h6>
            <h6>Last Participation : {data.lastParticipationDate}</h6>
          </div>
          <div className="col-sm-12 col-lg-6">
            <small>
        ...
        <div className="card-body">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 col-lg-2">
              ...
              <h6 className="mb-0">{data.minimumAmountInDeal}</h6>
            </div>
            <div className="col-sm-6 col-lg-2">
              <span>Max Amount</span>
              <h6 className="mb-0">{data.lenderPaticipationLimit}</h6>
            </div>
            <div className="col-sm-6 col-lg-2">
              <span>ATW</span>
            ...
            <div className="col-sm-6 col-lg-2">
              <span>ATW ROI</span>
              <h6 className="mb-0">{data.roiForWithdraw} %</h6>
            </div>
        ...
        <div className="card-footer">
          <div className="row align-items-center">
            <div className="col-auto">
              <a href={data.dealLink} className="badge bg-success-dark">
                Participate
              </a>
            </div>
