      ...
      datasource.push({
        ...
        action: (
          <Link to={nextPageUrl}>
            ...
            <i class="fa-solid fa-forward"></i>  Withdraw
            </button>
          </Link>
        ),
      });
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row col-12">
                      ...
                      <i class="fa-solid fa-piggy-bank"></i>      Withdraw From Escrow
                      </button>

                      <button  onClick={handleWithdrawFromNormal} className="btn btn-xs btn-primary col-md-2 col-xs-6 col-lg-4 mx-lg-2 my-xs-2">
                     <i class="fa-solid fa-piggy-bank"></i>   Withdraw from a Normal deal
                       </button>
                    </div>
                  </div>
