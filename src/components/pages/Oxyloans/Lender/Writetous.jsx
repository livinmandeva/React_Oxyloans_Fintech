...
import { getUserDetails ,writequery ,fileuploads} from "../../../HttpRequest/afterlogin";
              ...
              <div className="col-sm-12">
                <div className="card card-table">
                  <div className="card-body">
                    ...
                    <div className="row col-12">
                      <div className="col-12 col-sm-6">
                        <div className="form-group local-forms">
                          ...
                          name="queryfiledinput" onChange={handleChange} ></textarea>
                      ...
                      <div className="col-12 col-sm-6 ">
                        <div className="form-group local-forms pull-right">
                          <div className="form-group service-upload">
                            ...
                            <input type="file" multiple=""  onChange={imageSubmit} />
                          </div>
                    ...
                    <div className="row col-12">
                      <button className="btn btn-primary col-md-3 mx-3" onClick={handleWriteClick}>
                        Submit
                      </button>
                    </div>
                  </div>
