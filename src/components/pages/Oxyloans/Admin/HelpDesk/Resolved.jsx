...
const Resolved = () => {
  const [intrested, setintrested] = useState({
   ...
   const [reslove , setresolve] =useState({
    pageNo: 1,
    pageSize: 10,
    status: "",
    primaryType: ""  
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="row">
                          ...
                          <button type="button" className="btn btn-success col-lg-3 col-sm-6" onClick={()=>handelClickPendinglender("Completed"  ,"LENDER")}>
                           
                   
                          Resolved  Lender Queries
                          </button>

                          <button type="button" className="btn btn-info col-lg-3 col-sm-6" onClick={()=>handelClickPendingborrower("Completed"  ,"BORROWER")}    style={{marginLeft:'10px',}}>
