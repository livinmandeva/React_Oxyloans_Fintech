...
const [accessToken, setAccessToken] = useState('');   const [dataIpv6,setdataIpv6]=useState({});  const [dataIpv4,setdataIpv4]=useState("");
...
const handleLogin = () => {
  ...
  if (username.trim() === "@") { // Use () after trim to call the function
        ...
        <p>Loading...</p>
                  ...
                  {/* <form > */}  
                   ...
                   <div className="form-group">
                      ...
                      <input className="form-control" type="text"  value={username} name="username"  onChange={(event) => setUsername(event.target.value)}/>
