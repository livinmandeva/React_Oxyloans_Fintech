...
const Whatapplog = () => {
 ...
 const [dataIpv6,setdataIpv6]=useState({});  const [dataIpv4,setdataIpv4]=useState("");
// useEffect(()=>{
// alert(value)
// },[value])
          ...
          <div className="container">
            <div className="loginbox">
              ...
              <div className="login-right">
                {handlewhatapp ?  <> <div className="login-right-wrap">
 ...
 <h2>Sign in</h2>             
      ...
      onChange={setValue}/>
                    ...
                    <div className="form-group">
                      <button className="btn btn-primary btn-block"  type="submit" onClick={()=>sethandlewhatapp(false)}  >
                     Send OTP
                      </button>
                    </div>
                ...
                <h2>Otp verification</h2>        <div className="texts">          
                  ...
                  <OtpInput  />
                    ...
                    <div className="form-group">
                      <button className="btn btn-primary btn-block mt-4"  type="submit" onClick={()=>sethandlewhatapp(false)}  >
                     Submit 
                      </button>
                    </div>
                  {/* </form> */}
