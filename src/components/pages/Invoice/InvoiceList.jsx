                    ...
                    <ul className="app-listing">
                          ...
                          >
                            <form action="#">
                              ...
                              <div className="selectBox-cont">
                                ...
                                <label className="custom_check w-100">
                                  <input type="checkbox" name="username" />
                                  <span className="checkmark"></span> Hendry
                                  Evan
                                </label>
                                <label className="custom_check w-100">
                                  <input type="checkbox" name="username" />
                      ...
                      <li>
                        <div className="multipleSelection">
                          <div
                            className="selectBox"
                            onClick={() => toggleSetShowone(!show1)}
                          >
                            <p class="mb-0">
                      ...
                      <li>
                        <div className="multipleSelection">
                          <div
                            className="selectBox"
                            onClick={() => toggleSetShowtwo(!show2)}
                          >
                            <p class="mb-0">
                      ...
                      <li>
                        <div className="multipleSelection">
                          <div
                            className="selectBox"
                            onClick={() => toggleSetShowthree(!show3)}
                          >
                            <p class="mb-0">
                              <i class="fas fa-bookmark me-1 select-icon"></i>{" "}
                              By Category
                            </p>
                            <span class="down-icon">
                              <i class="fas fa-chevron-down"></i>
