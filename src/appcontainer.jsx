...
import CreateAgreements from "./components/pages/Oxyloans/Admin/AutoGenerated/CreateAgreements";
import LenderParticiaption from "./components/pages/Oxyloans/Admin/AutoGenerated/LenderParticiaption";
import DealBasedAggrements from "./components/pages/Oxyloans/Admin/AutoGenerated/DealBasedAggrements";
import Expiredloans from "./components/pages/Oxyloans/Admin/SUPERADMIN/Expiredloans";
import LendersLoansinfo from "./components/pages/Oxyloans/Admin/AutoGenerated/LendersLoansinfo";
import BorrowersLoansinfo from "./components/pages/Oxyloans/Admin/AutoGenerated/BorrowersLoansinfo";
import Thirtydaybucket from "./components/pages/Oxyloans/Admin/AutoGenerated/Thirtydaybucket";
import Sixtydaysbucket from "./components/pages/Oxyloans/Admin/AutoGenerated/Sixtydaysbucket";
import NinetyorNPAbuckets from "./components/pages/Oxyloans/Admin/AutoGenerated/NinetyorNPAbuckets";
import Ninetydaysbucket from "./components/pages/Oxyloans/Admin/AutoGenerated/Ninetydaysbucket";
import SendEmailActivationLink from "./components/pages/Oxyloans/Admin/AutoGenerated/SendEmailActivationLink";
import CreateUtmforpartnerDealer from "./components/pages/Oxyloans/Admin/AutoGenerated/CreateUtmforpartnerDealer";
import RemoveCredentials from "./components/pages/Oxyloans/Admin/SUPERADMIN/RemoveCredentials";
import ViewPartnerAndDealer from "./components/pages/Oxyloans/Admin/AutoGenerated/ViewPartnerAndDealer";
...
export const newRouter = createBrowserRouter([
  ...
  {
    path: "/thirtydaybucket",
    element: <Thirtydaybucket />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/sixtydaysbucket",
    element: <Sixtydaysbucket />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/ninetyorNPAbuckets",
    element: <NinetyorNPAbuckets />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/borrowersLoansinfo",
    element: <BorrowersLoansinfo />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/sendEmailActivationLink",
    element: <SendEmailActivationLink />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/ninetydaysbucket",
    element: <Ninetydaysbucket />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/lendersLoansinfo",
    element: <LendersLoansinfo />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/removeCredentials",
    element: <RemoveCredentials />,
    errorElement: <Error404></Error404>,
  },
  {
  ...
  {
    path: "/viewPartnerAndDealer",
    element: <ViewPartnerAndDealer />,
    errorElement: <Error404></Error404>,
  },
  {
  ...
  {
    path: "/eNACHActiveUsers",
    element: <ENACHActiveUsers />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/uploadedStatus",
  ...
  {
    path: "/dealBasedAggrements",
    element: <DealBasedAggrements />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/expiredloans",
    element: <Expiredloans />,
    errorElement: <Error404></Error404>,
  },
  {
    path: "/approvedloan",
